...
public interface BillOrderMapper 
{
    ...
    List<BillOrder> selectBillOrderListByDeptIds(@Param("billOrder")BillOrder billOrder,@Param("deptIds") List<Long> deptIds);

    List<BillOrder> selectRKBillOrderListByDeptIds(@Param("billOrder")BillOrder billOrder,@Param("deptIds")  List<Long> deptIds);
}
