...
@Slf4j
@Component("dealBoxCodeApplyTask")
public class DealBoxCodeApplyTask {
    ...
    @Autowired
    private IDealBoxCodeApplyTaskService dealBoxCodeApplyTaskService;
        ...
        if (!isRunning) {
            synchronized (lock) {
                try {
                    ...
                    dealBoxCodeApplyTaskService.dealApply();
