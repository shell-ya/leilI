...
//                    return AjaxResult.error("积分不足，每份所需积分为："+needIg);
                    return AjaxResult.error( MessageUtils.message("error.msg.insufficientpints") +needIg);
                }
            }else{

//                return  AjaxResult.error("兑换失败，该产品不予兑换，请联系工作人员");
                return  AjaxResult.error(MessageUtils.message("error.msg.redeemfailed"));
            }
...
//            return  AjaxResult.error("兑换失败，请联系开发人员");
            return  AjaxResult.error(MessageUtils.message("error.msg.exchangefailed"));
        }
