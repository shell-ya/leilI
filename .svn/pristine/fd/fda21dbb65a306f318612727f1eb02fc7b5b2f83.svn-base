...
import com.linkwin.framework.shiro.util.AuthorizationUtils;
import com.linkwin.system.service.ISysPostService;
...
public class SysUserController extends BaseController
{
     ...
     */
    @GetMapping("/add")
    public String add(ModelMap mmap,@RequestParam(name = "language") String language)
    {
        mmap.put("roles", roleService.selectRoleAll(language).stream().filter(r -> !r.isAdmin()).collect(Collectors.toList()));
        mmap.put("posts", postService.selectPostAll(language));
        return prefix + "/add";
    }
    ...
    public String edit(@PathVariable("userId") Long userId, ModelMap mmap,@RequestParam(name = "language") String language)
    {
        userService.checkUserDataScope(userId);
//        List<SysRole> roles = roleService.selectRolesByUserId(userId);
        List<SysRole> roles = roleService.selectRolesByUserIdAndLanguage(userId,language);
        mmap.put("user", userService.selectUserById(userId));
//        mmap.put("roles", SysUser.isAdmin(userId) ? roles : roles.stream().filter(r -> !r.isAdmin()).collect(Collectors.toList()));
//        mmap.put("posts", postService.selectPostsByUserId(userId));
        mmap.put("roles", SysUser.isAdmin(userId) ? roles :roleService.selectRoleAll(language).stream().filter(r -> !r.isAdmin()).collect(Collectors.toList()));
        mmap.put("posts", postService.selectPostAll(language));
        return prefix + "/edit";
    }
    ...
    public String authRole(@PathVariable("userId") Long userId, ModelMap mmap,@RequestParam("language") String language)
    {
