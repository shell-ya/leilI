...
import com.linkwin.common.core.domain.entity.SysDictType;
import com.linkwin.common.core.text.Convert;
import com.linkwin.common.exception.ServiceException;
import com.linkwin.common.utils.DictUtils;
import com.linkwin.common.utils.StringUtils;
import com.linkwin.system.mapper.SysDictDataMapper;
import com.linkwin.system.mapper.SysDictTypeMapper;
...
public class SysDictTypeServiceImpl implements ISysDictTypeService
{
     ...
     */
    @Override
    public List<SysDictData> selectDictDataByType(String dictType,String language)
    {
        List<SysDictData> dictDatas = DictUtils.getDictCache(language + "_" +dictType);
        if (StringUtils.isNotEmpty(dictDatas))
        {
            return dictDatas;
        }
        dictDatas = dictDataMapper.selectDictDataByTypeAndLanguage(dictType,language);
        if (StringUtils.isNotEmpty(dictDatas))
        {
            DictUtils.setDictCache(language + "_" +dictType, dictDatas);
            return dictDatas;
        }
        return null;
    }
