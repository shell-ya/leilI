...
import com.linkwin.common.core.domain.entity.SysMenu;
...
import com.linkwin.system.mapper.SysMenuMapper;
...
public class SysMenuServiceImpl implements ISysMenuService
{
    ...
    public List<SysMenu> selectMenusByUser(SysUser user)
    {
        ...
        if (user.isAdmin())
        {
            menus = "en_US".equals(language) ? menuMapper.selectEnglishMenuNormalAll(): menuMapper.selectMenuNormalAll();
        }
        else
        {
            menus = "en_US".equals(language) ? menuMapper.selectEnglishMenusByUserId(user.getUserId()) : menuMapper.selectMenusByUserId(user.getUserId());
        }
