...
public class SysDictDataServiceImpl implements ISysDictDataService
{
    ...
    @Override
    public String selectDictLabel(String dictType, String dictValue, String language) {
        return dictDataMapper.selectDictLabelBuLanguage(dictType, dictValue,language);
    }
